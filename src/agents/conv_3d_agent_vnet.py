...
class Conv3dAgentValueNet(BaseAgent):
    def __init__(self, config):
        ...
        self.use_subsampling = int(config.get("use_subsampling", 1))
        ...
        if self.use_batch_norm:
            self.norm1 = nn.BatchNorm3d(input_channel_list[layer_count])
        ...
        if self.use_batch_norm:
            self.norm2 = nn.BatchNorm3d(input_channel_list[layer_count])
        ...
        if self.use_batch_norm:
            self.norm3 = nn.BatchNorm3d(input_channel_list[layer_count])
        ...
        # TODO: think of some smart poolong or subsampling
        ...
        if self.use_batch_norm:
            self.norm7 = nn.BatchNorm1d(input_neuron_numbers[lin_layer_count])
