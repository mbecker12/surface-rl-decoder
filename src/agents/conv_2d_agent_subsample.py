...
class Conv2dAgentSubsample(BaseAgent):
    def __init__(self, config):
        ...
        self.output_layer = nn.Linear(
            int(input_neuron_numbers[-1]), self.output_neurons
        )
    ...
    def forward(self, state: torch.Tensor):
        ...
        # print(f"{final_output.grad_fn=}, {final_output.grad=}, {final_output.retain_grad=}, {final_output.requires_grad=}")
        return final_output
